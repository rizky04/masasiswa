...
@section('page_title', 'Validasi LHU')
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach ($an->pcpar as $par)
                                        <strong>{{ $par->nama_parameter_in ?? '-' }}</strong>
                                    @endforeach
                                </td>
                                ...
                                <td>
                                    ...
                                    <b>Tanggal Proses MT:</b>
                                    {{ \Carbon\Carbon::parse($an->tgl_perkiraan_analisaselesai)->subDays(5)->format('d-m-Y') }}<br>
                                    <b>Tanggal Terima Korlab:</b>
                                    {{ \Carbon\Carbon::parse($an->tgl_perkiraan_analisaselesai)->subDays(3)->format('d-m-Y') }}
                                </td>

                                <td>
                                    <b>Logo KAN:</b> {{ $an->logo_kan ?? 'ya' }}<br>
                                    <b>Penandatangan:</b> {{ $an->penandatangan ?? 'Roni Cristiono' }}<br>
                                    <b>Jenis ttd:</b> {{ $an->jenis_ttd ?? 'elektronik' }}<br>

                                    {{-- Tombol lihat file PDF LHU --}}
