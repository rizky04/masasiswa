    ...
    <form action="{{ route('analis.input-hasil.update') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-row align-items-end mb-3">
        <div class="form-group col-md-6">
          ...
          <input type="text" name="contoh_uji" id="contoh_uji" class="form-control editor" required>
        </div>
        <div class="form-group col-md-6">
      ...
      <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0"><strong>2. Data Teknis Uji Kemasan <br> A. Uji Kemasan </strong></h5>
      ...
      <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0"><strong>B. Identifikasi Contoh Uji</strong></h5>
      ...
      <!-- 4. Data Program Uji -->
      <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0"><strong>3. Data Program Uji</strong></h5>
      ...
      <!-- 5. Data Hasil Uji -->
      <div class="d-flex justify-content-between align-items-center mb-2">
        <h5 class="mb-0"><strong>4. Data Hasil Uji</strong></h5>
...
<script>
  ...
  // Tambah dinamis (semua tipe)
  const sections = [
    {btn: '#addDataTeknis', wrap: '#dataTeknisWrapper', cls: 'data-teknis-item', html: `
      <div class="form-row data-teknis-item mb-3 p-3 border rounded bg-light">
        <div class="form-group col-md-5">
          <label>Subject Uji Kemasan</label>
          <input type="text" name="subject_uji[]" class="form-control" required>
    ...
    {btn: '#addDataIdentifikasi', wrap: '#dataIdentifikasiWrapper', cls: 'data-identifikasi-item', html: `
      <div class="form-row data-identifikasi-item mb-3 p-3 border rounded bg-light">
        <div class="form-group col-md-5">
          <label>Nama Teknis Identifikasi</label>
          <input type="text" name="nama_teknis_identifikasi[]" class="form-control" required>
    ...
    {btn: '#addProgramUji', wrap: '#programUjiWrapper', cls: 'program-uji-item', html: `
      <div class="form-row program-uji-item mb-3 p-3 border rounded bg-light">
        <div class="form-group col-md-3">
          <label>Jenis Program Uji</label>
          <select name="jenis_program_uji[]" class="form-control" required>
            <option value="">-- Pilih Jenis --</option>
            <option value="Uji Jatuh">Uji Jatuh</option>
            <option value="Uji Tekanan">Uji Tekanan</option>
            <option value="Uji Dalam">Uji Dalam</option>
          </select>
        </div>
        <div class="form-group col-md-4">
          <label>Nama Program Uji</label>
    ...
    {btn: '#addHasilUji', wrap: '#hasilUjiWrapper', cls: 'hasil-uji-item', html: `
      <div class="form-row hasil-uji-item mb-3 p-3 border rounded bg-light">
        <div class="form-group col-md-3">
          <label>Jenis Program Uji</label>
          <select name="jenis_program_uji[]" class="form-control" required>
